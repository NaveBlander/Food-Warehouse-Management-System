...
class Volunteer {
    public:
        ...
        virtual char getTypeVolunteer() = 0; //Added by us

        virtual ~Volunteer() = default; // we added
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        char getTypeVolunteer() override; //Added by us
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        string toString() const override;
        void setDistanceLeft(const int distanceToSet);
